      ...
      <aside className="sidebar">
        <div className="sidebar-inner">
          <div className="sidebar-brand">
            ...
            {!user ? (
              <button className="sidebar-cta-btn" onClick={() => setShowAuth(true)}>
              ...
              <Link to="/pricing" className="sidebar-cta-btn sidebar-cta-upgrade">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="16 12 12 8 8 12"/><line x1="12" y1="16" x2="12" y2="8"/></svg>
                {lang === 'zh' ? '升级 Pro' : 'Upgrade'}
              </Link>
            ) : null}
          </div>
