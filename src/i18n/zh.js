export default {
  ...
  'pricing.basicTools': '基础功能',
  'pricing.adjust': '图片调整',
  'pricing.watermarkPos': '水印位置',
  'pricing.templates': '模板保存',
  'pricing.exportQuality': '导出最高质量',
  'pricing.ads': '广告',
  'pricing.free.daily': '100 张',
  'pricing.free.batch': '30 张',
  'pricing.free.basicTools': '裁剪/缩放/压缩/转换/水印/边框',
  'pricing.free.adjust': '不可用',
  'pricing.free.watermarkPos': '固定右下角',
  'pricing.free.templates': '2 个',
  'pricing.free.ads': '有',
  'pricing.pro.daily': '无限制',
  'pricing.pro.batch': '100 张',
  'pricing.pro.basicTools': '全部功能',
  'pricing.pro.adjust': '亮度/对比度/饱和度',
  'pricing.pro.watermarkPos': '自由选择位置',
