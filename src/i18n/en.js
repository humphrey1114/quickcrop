export default {
  ...
  'settings.autoFocal': 'Smart Focal Detection',
  ...
  'tutorial.step3.desc': 'With "Smart Focal Detection" enabled, the system automatically identifies the main subject. You can also click or drag on the image to manually adjust the focal point. Cropped areas are shown with a gray overlay.',
  ...
  'faq.q5': 'What is Smart Focal Detection?',
  'faq.a5': 'Smart Focal Detection analyzes image content to find the most important areas (faces, text, main subjects) and prioritizes keeping them during cropping. You can also click on the image to set the focal point manually.',
  ...
  'changelog.v1.0.0.3': 'Smart focal point detection to identify image subjects',
  ...
  'about.v.smart': 'Smart',
  'about.v.smart.desc': 'AI focal detection automatically identifies image subjects',
