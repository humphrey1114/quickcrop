...
const routes = [
  ...
  { path: '/jpg-to-png', priority: '0.9', freq: 'weekly' },
  { path: '/svg-to-png', priority: '0.9', freq: 'weekly' },
  { path: '/gif-to-mp4', priority: '0.9', freq: 'weekly' },
  { path: '/image-to-pdf', priority: '0.9', freq: 'weekly' },
  { path: '/passport-photo', priority: '0.9', freq: 'weekly' },
  { path: '/smart-crop', priority: '0.9', freq: 'weekly' },
